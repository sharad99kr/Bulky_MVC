    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Minus(int cartId) {
            ...
            if(cartFromDb.Count <= 1) {
                ...
                int countOfItemsInCart = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == cartFromDb.ApplicationUserId).Count();
                HttpContext.Session.SetInt32(SD.SessionCart, countOfItemsInCart - 1);
